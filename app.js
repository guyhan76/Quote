...
(function(){
  ...
  window.REF_SAMPLE['코팅비참조'] = {
    ...
    rows: [
      ...
      ['유광CR','1m²',60,16000,'최대규격 1440*1000'],
      ['무광CR','1m²',105,16000,'최대규격 1440*1000'],
      ['오바코팅','1m²',79,23000,'최대규격 1440*1000'],
      ['유광라미','1m²',130,30000,'최대규격 1430*1100'],
      ['유광라미(1300이상)','1m²',170,35000,'최대규격 1430*1100'],
      ['무광라미','1m²',140,35000,'최대규격 1430*1100'],
      ['무광라미(1300이상)','1m²',180,35000,'최대규격 1430*1100'],
      ['UV코팅','1m²',80,'','788*1091'],
      ['창문(타공)라미','1m²',158,'',''],
      ['고주파(PET)','1m²',130,'',''],
    ]
...
window.REF_SAMPLE['용지가격참조'] = {
  ...
  rows: [
    ['SC', 220, 1542, 1010, 34.5, 940, 0.39, '한솔 기준(특가건 별도 협의)'],
    ['SC', 240, 1494, 1091, 27, '', '', '한솔 기준(특가건 별도 협의)'],
    ['SC', 300, 1406, 1026, 27, '', '', '한솔 기준(특가건 별도 협의)'],
    ['SC', 350, 1401, 1023, 27, '', '', '한솔 기준(특가건 별도 협의)'],
    ['SC', 400, 1380, 1007, 27, '', '', '한솔 기준(특가건 별도 협의)'],

    ['IV', 240, 1890, 1342, 29, '', '', '한솔 기준(특가건 별도 협의)'],
    ['IV', 300, 1822, 1294, 29, '', '', '한솔 기준(특가건 별도 협의)'],
    ['IV', 350, 1803, 1280, 29, '', '', '한솔 기준(특가건 별도 협의)'],
    ['IV', 400, 1788, 1270, 29, '', '', '한솔 기준(특가건 별도 협의)'],

    ['RIV', 230, 2834, 1984, 30, '', '', '한솔 AB'],
    ['RIV', 300, 2786, 1950, 30, '', '', '한솔 AB'],
    ['RIV', 350, 2786, 1950, 30, '', '', '한솔 AB'],
    ['RIV', 400, 2786, 1950, 30, '', '', '한솔 AB'],
    ['RIV', 450, 2786, 1950, 30, '', '', '한솔 AB'],

    ['CCP', 300, 2995, 2156, 28, '', '', '한창 CCP'],
    ['CCP', 350, 2995, 2156, 28, '', '', '한창 CCP'],
    ['CCP', 400, 2995, 2156, 28, '', '', '한창 CCP'],

    ['스노우', 200, 2082, 1499, 28, '', '', ''],
    ['스노우', 250, 2082, 1499, 28, '', '', ''],
    ['스노우', 300, 2082, 1499, 28, '', '', ''],

    ['무염료KRAFT', 240, 1598, 1087, 32, '', '', '깨나라 기준'],
    ['무염료KRAFT', 300, 1505, 1023, 32, '', '', '깨나라 기준'],
    ['무염료KRAFT', 350, 1496, 1017, 32, '', '', '깨나라 기준'],
    ['무염료KRAFT', 400, 1473, 1002, 32, '', '', '깨나라 기준'],
    ...
    ['편아트지', 140, 2066, 1653, 20, '', '', ''],
    ['편아트지', 160, 2066, 1653, 20, '', '', ''],

    ['양아트지', 200, 2082, 1499, 28, '', '', ''],
    ['양아트지', 250, 2082,1499, 28, '', '', ''],

    ['알리킹', '', 2619, 1650, 37, '', '', ''],

    ['모조지', 100, 2058, 1482, 28, '', '', ''],
    ['모조지', 120, 2058, 1482, 28, '', '', ''],
    ['모조지', 150, 2058, 1482, 28, '', '', ''],
    ['모조지', 180, 2058, 1482, 28, '', '', ''],
...
window.REF_SAMPLE['옵셋인쇄비참조'] = {
  ...
  rows: [
    ...
    [ 9,  8000, 10000, 15000, '', '별색', '금색,은색,핑크', '기본3도' ],
    [10,  8000, 10000, 15000, '', '', '', '' ],

    [11,  7000,  9000, 13000, '', '', '최소', '종이최대', '인쇄최대면적', 'CTP장당가격' ],
    [12,  7000,  9000, 13000, '', '대국전', '394*520', '740*1040', '700*1005', '10000' ],
    [13,  7000,  9000, 13000, '', '하드롱', '520*750', '980*1310', '940*1285', '22000' ],

    [14,  6500,  9000, 13000, '', '특하드롱', '620*850', '1130*1630', '1090*1580', '25000' ],
    [15,  6500,  9000, 13000, '', '', '', '' ],
    [16,  6500,  9000, 13000, '', '', '', '' ],
