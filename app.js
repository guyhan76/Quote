...
window.REF_SAMPLE['용지가격참조'] = {
  ...
  rows: [
    ...
    ['편아트지', 140, 2066, 1653, 0.2, '', '', ''],
    ['편아트지', 160, 2066, 1653, 0.2, '', '', ''],

    ['양아트지', 200, 2082, 1499, 0.28, '', '', ''],
    ['양아트지', 250, 2082,1499, 0.28, '', '', ''],

    ['알리킹', '', 2619, 1650, 0.37, '', '', ''],

    ['모조지', 100, 2058, 1482, 0.28, '', '', ''],
    ['모조지', 120, 2058, 1482, 0.28, '', '', ''],
    ['모조지', 150, 2058, 1482, 0.28, '', '', ''],
    ['모조지', 180, 2058, 1482, 0.28, '', '', ''],
